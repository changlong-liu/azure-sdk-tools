...
```
autorest --version=3.6.2 --use=@autorest/go@4.0.0-preview.30 --use=<testgen extension> --go --track2 --output-folder=<RP package path> --file-prefix="zz_generated_" --clear-output-folder=false --go.clear-output-folder=false --testmodeler.generate-mock-test --testmodeler.generate-sdk-example --testmodeler.generate-scenario-test --generate-sdk=false --debug  <RP config md file path>
```
...
use-extension:
  "@autorest/go" : "4.0.0-preview.30"
  "@autorest/testmodeler" : "0.1.0-preview"
